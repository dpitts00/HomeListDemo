...
extension HouseholdItem: Sortable {
    static func standardSorts() -> [any SortSelection] {
        return [
            StringSortSelection(displayName: "Name asc", keyPath: \HouseholdItem.name, ascending: true),
            StringSortSelection(displayName: "Name desc", keyPath: \HouseholdItem.name, ascending: false),
